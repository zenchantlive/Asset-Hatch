...
app/
└── project/[id]/
    ├── generation/page.tsx          # MODIFY: Add export button
    └── export/page.tsx              # NEW: Export page

lib/
├── manifest-builder.ts              # NEW: Generate manifest.json
└── export-packer.ts                 # NEW: Create ZIP package
```
...
**If all pass: Core MVP is complete! 🎉**
